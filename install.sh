...
echo "══════════════════════════════════════════"
echo ""
echo "Open Claude Desktop with Cowork mode enabled, then paste this prompt:"
echo ""
...
echo "The AI will walk you through the rest — you won't need to open a terminal again."
echo ""
